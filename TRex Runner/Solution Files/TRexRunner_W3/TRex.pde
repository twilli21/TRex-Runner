public class TRex
{
  ...
  private float yGravity; //TRex velory along y axis due to gravity
  private PImage TRexSprite;
  private PImage TRexLeftUp;
  private PImage TRexRightUp;
  private PImage TRexDead;
  
  private TRexRunner_W3 game;

  public TRex(TRexRunner_W3 game)
  {
    this.game = game;
    w = 50;
    h = 50;
  ...
  {
    if (game.isBeginning || game.isUpperKeyDisabled)
    {
